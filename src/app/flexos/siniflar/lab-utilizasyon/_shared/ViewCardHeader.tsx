  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14, flexWrap: "wrap", padding: "16px 18px", borderBottom: "1px solid " + T.border }}>
      <div style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
        <button type="button" onClick={onPrev} style={navBtnStyle}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round"><path d="m15 18-6-6 6-6" /></svg></button>
        <button type="button" onClick={onToday} style={{ padding: "0 14px", height: 34, borderRadius: 9, border: "1px solid " + T.border, background: T.panel, color: T.text2, fontSize: 13, fontWeight: 600, fontFamily: "inherit", cursor: "pointer" }}>Bugün</button>
        <button type="button" onClick={onNext} style={navBtnStyle}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6" /></svg></button>
