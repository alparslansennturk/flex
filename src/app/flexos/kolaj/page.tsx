...
/**
 * FlexOS · Kolaj Bahçesi çekiliş sayfası (`/flexos/kolaj?assignmentId=`) — canlıdaki
 * `shared/AssignmentScreen.tsx` + `EntryScreen`in portu (intro fazı yok, direkt
 * entry→game). Ödevin durumu zaten "published/closed/archived" ise (seçim bitmiş)
 * normal Ödev Notu akışına yönlendirir.
 */
...
function EntryScreen({
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "linear-gradient(150deg, #060D1A 0%, #0D1F38 55%, #060D1A 100%)" }}>
...
export default function KolajPage() {
  return (
    <Suspense fallback={
