...
/**
 * FlexOS · Reklam Tasarımı (Sosyal Medya) çekiliş sayfası (`/flexos/sosyal?assignmentId=`)
 * — `flexos/kolaj/page.tsx`/`flexos/kitap/page.tsx` ile birebir aynı desen
 * (EntryScreen→SocialGameScreen), sadece hedef ekran farklı.
 */
