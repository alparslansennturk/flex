...
// Canlıdaki `assignment/social/generateSocialPdf.tsx` ile birebir port — TEK fark:
// font Roboto yerine Inter (Kolaj/Kitap portlarındaki 2026-07-07 kararıyla aynı gerekçe).
...
const s = StyleSheet.create({
  ...
  headerTitle: { fontSize: 22, fontWeight: 700, color: BLUE, textAlign: "center", letterSpacing: 1, marginBottom: 4 },
  headerSub: { fontSize: 11, fontWeight: 400, color: "#666666", textAlign: "center", letterSpacing: 0.5, marginBottom: 28 },
  topRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 20 },
  brandName: { fontSize: 20, fontWeight: 700, color: "#111111" },
  sektorText: { fontSize: 11, fontWeight: 400, color: "#555555", marginTop: 3 },
  studentLabel: { fontSize: 12, fontWeight: 700, color: "#111111", textAlign: "right" },
  table: { borderWidth: 1, borderColor: "#cccccc", marginBottom: 24 },
  tableRow: { flexDirection: "row", borderBottomWidth: 1, borderBottomColor: "#cccccc" },
  tableRowLast: { flexDirection: "row" },
  tableCellKey: {
    width: 120, padding: "8 10", fontSize: 11, fontWeight: 700, color: "#111111",
    borderRightWidth: 1, borderRightColor: "#cccccc", backgroundColor: "#f9f9f9",
  },
  tableCellVal: { flex: 1, padding: "8 10", fontSize: 11, color: "#222222", lineHeight: 1.5 },
  sectionTitle: { fontSize: 12, fontWeight: 700, color: "#111111", marginBottom: 8 },
  bullet: { flexDirection: "row", marginBottom: 5, paddingLeft: 4 },
  bulletDot: { fontSize: 11, color: "#333333", width: 14 },
  bulletText: { fontSize: 11, color: "#222222", flex: 1, lineHeight: 1.5 },
  divider: { borderBottomWidth: 1.5, borderBottomColor: BLUE, marginTop: 24, marginBottom: 10 },
  footer: { fontSize: 10, color: "#888888", textAlign: "right" },
});
