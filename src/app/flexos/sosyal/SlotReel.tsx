...
// Canlıdaki `assignment/social/SlotReel.tsx` ile birebir port — 3 paralel reel'in
// her biri kendi delay'iyle döner/yavaşlar/kilitlenir (bkz. SocialGameScreen.tsx).
