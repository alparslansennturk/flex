...
const ICONS: Record<string, string> = {
  ...
  community: '<path d="M8.2 5a4 4 0 0 0 0 7.2"/><path d="M15.8 5a4 4 0 0 1 0 7.2"/><circle cx="12" cy="7.6" r="3.3"/><path d="M1.8 20.3a4 4 0 0 1 4.2-4"/><path d="M22.2 20.3a4 4 0 0 0-4.2-4"/><path d="M7.5 21a4.5 4.5 0 0 1 9 0"/>',
