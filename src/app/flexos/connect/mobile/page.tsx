...
const ICONS: Record<string, string> = {
  ...
  community: '<circle cx="5" cy="8" r="2.6"/><path d="M2 20v-.5a4 4 0 0 1 4-4"/><circle cx="19" cy="8" r="2.6"/><path d="M22 20v-.5a4 4 0 0 0-4-4"/><circle cx="12" cy="9" r="3.4"/><path d="M17 21a5 5 0 0 0-10 0"/>',
