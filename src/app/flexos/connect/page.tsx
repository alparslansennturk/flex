...
import {
  Users, UsersRound, Plus, Search, Send, X, Check, CheckCheck, Loader2,
  Minimize2, Info, MoreVertical, LogOut, Star, StarOff, Pencil, Trash2, Smile,
  ChevronDown, Reply, Copy, Settings, FileText, ChevronRight, ArrowLeft, Eraser,
} from "lucide-react";
...
import { withTimeout, initials, fmtTime, fmtFileSize, dayKey, dividerLabel as dividerLabelBase, PresenceDot } from "./_shared/format";
