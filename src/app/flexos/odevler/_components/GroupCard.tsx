...
/**
 * FlexOS · Ödevler — Grup kartı. Canlıdaki `src/app/components/assignment-test/GroupCard.tsx`
 * ile BİREBİR (renkler, arşivleme modalı, hover davranışı) — sadece prop kaynakları FlexOS
 * domain'ine (Group/Assignment/Submission) bağlandı.
 */
...
export default function GroupCard({
  id, code, session, branch, instructor,
  studentCount, activeTaskCount, submissionCount, status,
  onClick, onArchive,
}: GroupCardProps) {
                ...
                >
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      setMenuOpen(false);
                      if (isArchived) onArchive(id, false);
