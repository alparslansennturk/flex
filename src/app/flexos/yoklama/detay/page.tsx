 ...
 * Canlıdaki `/dashboard/attendance` karşılığı — Yoklama Al'ın aksine grup önceden
 * seçili DEĞİL, kullanıcı soldaki listeden doğrudan bir grup seçip düzenleme/detay
 * moduna girer (Yoklama Al akışından geçmeden). Aynı bağımsız-sayfa deseni (FlexSidebar
 * yok, kendi başlık çubuğu, yeni sekmede açılır).
 */
...
export default function YoklamaDetayPage() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-neutral-50 flex flex-col">
      ...
      <main className="flex-1 overflow-y-auto">
        <AttendanceCore mode="detail" allowEdit enforceTimeWindow />
      </main>
    </div>
  );
}
