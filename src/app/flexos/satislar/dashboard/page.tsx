...
const APPT_VISIBLE_ROWS = 4; // tam olarak bu kadarı sığar, fazlası kaydırılır
...
export default function SatisDashboardPage() {
  ...
  const loadAll = useCallback(async (signal?: AbortSignal) => {
    ...
    try {
      ...
      const [salesRes, apptRes, actRes] = await Promise.all([
      ...
      <main style={{ flex: 1, height: "100%", overflowY: "auto", background: "#EEF0F3" }}>
        ...
        <header style={{ position: "sticky", top: 0, zIndex: 30, background: "#fff", borderBottom: "1px solid #E2E5EA", boxShadow: "0 2px 6px rgba(15,31,61,.04)" }}>
          <div style={{ maxWidth: 1560, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 24, padding: "20px 36px" }}>
            <div>
              <h1 style={{ margin: 0, fontSize: 19, fontWeight: 800, letterSpacing: "-.3px", color: "#1E222B" }}>Hoş Geldin, Alparslan 😊</h1>
              <p style={{ margin: "4px 0 0", fontSize: 12.5, color: "#8E95A3", fontWeight: 500 }}>Bugün satışlarda neler oluyor? İşte son durum.</p>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, paddingLeft: 18, borderLeft: "1px solid #E2E5EA" }}>
                <div style={{ textAlign: "right" as const, lineHeight: 1.3 }}>
                  ...
                  <div style={{ fontSize: 11.5, color: "#8E95A3", fontWeight: 500 }}>Yönetici · Satış</div>
                </div>
        ...
        <div style={{ padding: "28px 36px 56px", maxWidth: 1560, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 340px", gridTemplateRows: "auto auto auto", gap: 20, alignItems: "stretch" }}>
          ...
          <div style={{ gridColumn: 1, gridRow: 1, position: "relative", background: "#fff", border: "1px solid #E2E5EA", borderRadius: 24, padding: "24px 28px 32px", boxShadow: "0 4px 20px -12px rgba(15,31,61,.15)", minHeight: 252, display: "flex", flexDirection: "column" }}>
            ...
            {loading ? (
              ...
              <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 40, flexWrap: "wrap" }}>
                ...
                <div style={{ flex: 1, minWidth: 240, display: "grid", gridTemplateColumns: donutTopCount <= 2 ? "1fr" : "1fr 1fr", gap: 10 * donutScale, alignSelf: "center" }}>
                  {donut.legend.filter((l) => !l.detail).map((l) => (
                    <div key={l.label} style={{ display: "flex", alignItems: "center", gap: 11 * donutScale, padding: `${13 * donutScale}px ${14 * donutScale}px`, borderRadius: 13, background: "#F7F8FA", border: "1px solid #EEF0F3" }}>
                      ...
                      <div style={{ minWidth: 0 }}>
                        <div style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
                          <span style={{ fontSize: 19 * donutScale, fontWeight: 800, color: "#1E222B", letterSpacing: "-.4px", lineHeight: 1 }}>{l.pct}%</span>
                          <span style={{ fontSize: 11 * donutScale, color: "#AEB4C0", fontWeight: 600 }}>{l.count} kayıt</span>
                        </div>
          ...
          <div style={{ gridColumn: 1, gridRow: 2, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            <button
              ...
              style={{ textAlign: "left" as const, textDecoration: "none", background: "#fff", border: "1px solid #E2E5EA", borderRadius: 22, padding: 22, display: "flex", flexDirection: "column", boxShadow: "0 4px 20px -12px rgba(15,31,61,.15)", cursor: "pointer", fontFamily: "inherit" }}
            >
              ...
              <div style={{ flex: 1, fontSize: 13, color: "#6F7B87", fontWeight: 500, lineHeight: 1.5 }}>Öğrenci bilgisi, eğitim ve ödeme adımlarıyla anında satışa başla.</div>
              <div style={{ marginTop: 14, display: "flex", width: "100%", alignItems: "center", justifyContent: "center", gap: 7, padding: "10px 16px", borderRadius: 11, background: "linear-gradient(135deg,#FF8D28,#D66500)", color: "#fff", fontSize: 13.5, fontWeight: 700, boxShadow: "0 8px 16px -8px rgba(214,101,0,.5)" }}>
                Başla
            ...
            >
              ...
              <div style={{ marginTop: 12, display: "flex", width: "100%", alignItems: "center", justifyContent: "center", gap: 7, padding: "9px 14px", borderRadius: 11, border: "1px solid #E2E5EA", background: "#fff", color: "#205297", fontSize: 13, fontWeight: 700 }}>
                Satış Listesini Aç
          ...
          <div style={{ gridColumn: 1, gridRow: 3 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 14 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
                ...
                <span style={{ fontSize: 17, fontWeight: 800, color: "#1E222B", letterSpacing: "-.2px" }}>Aktif Satışlar</span>
              </div>
          ...
          <div style={{ gridColumn: 2, gridRow: 1, background: "#fff", border: "1px solid #E2E5EA", borderRadius: 24, padding: 20, boxShadow: "0 4px 20px -12px rgba(15,31,61,.15)", display: "flex", flexDirection: "column", minHeight: 244, overflow: "hidden" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: APPT_ROW_GAP, overflowY: "auto", flex: 1, minHeight: 0, maxHeight: APPT_LIST_PAD + APPT_ROW_HEIGHT * APPT_VISIBLE_ROWS + APPT_ROW_GAP * (APPT_VISIBLE_ROWS - 1), paddingTop: APPT_LIST_PAD, paddingRight: 2 }}>
