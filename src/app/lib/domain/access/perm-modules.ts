...
export const BUILT_IN_ROLE_SEEDS: BuiltInRoleSeed[] = [
  ...
  { id: "egitim_koordinatoru", label: "Eğitim Koordinatörü", description: "Eğitim operasyonunun başı", color: "#0369A1", permModules: ["kisi", "kayit", "sinif", "not", "egitmen_ekle", "egitmen", "katalog", "satis_liste", "aktivite"] },
