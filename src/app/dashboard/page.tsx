"use client";
        ...
        <main className="flex-1 lg:pl-64 flex flex-col min-h-screen w-full">
          ...
          <div className="p-4 md:p-8 lg:p-10 w-full max-w-[1540px] 2xl:max-w-[1700px] mx-auto space-y-8 flex-1">
            ...
            <div className="grid grid-cols-12 gap-6 items-stretch">
              ...
              <div className="col-span-12 xl:col-span-4 bg-white rounded-[32px] p-6 md:p-8 border border-surface-200 flex flex-col justify-between shadow-sm">
                <div className="flex items-center justify-between mb-6">
                  ...
                  >
                    <span className="text-xs md:text-[12px] font-bold capitalize-first">
                      {viewMode === 'Şubem' ? instructorBranch : viewMode}
                    </span>
            ...
            <section className="space-y-6 pt-4 pb-12">
              <div className="flex items-center gap-3 text-text-tertiary px-2">
                <LibraryBig size={24} />
              ...
              <div className="relative group">
                <button 
                  ...
                  className="absolute -left-5 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-white flex items-center justify-center text-neutral-900 shadow-xl border-none transition-transform hover:scale-110 active:scale-95"
                >
                  <ChevronLeft size={24} />
                </button>
                ...
                <button 
                  ...
                  className="absolute -right-5 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-white flex items-center justify-center text-neutral-900 shadow-xl border-none transition-transform hover:scale-110 active:scale-95"
                >
                  <ChevronRight size={24} />
                </button>

                {/* Responsive Kartlar: 1440 ve 2K ekranlarda 4.3 kart oranı sağlandı */}
  ...
  function LibraryCard({ title, desc }: LibraryCardProps) {
    return (
      <div className="min-w-[calc((100%-96px)/4.3)] snap-start bg-white p-6 md:p-7 rounded-[28px] border border-surface-100 flex flex-col justify-between h-[210px] transition-all group hover:border-surface-300">
