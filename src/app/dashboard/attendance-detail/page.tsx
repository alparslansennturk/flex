...
import {
  ...
  TrendingUp, ChevronLeft, Search, X,
} from "lucide-react";
...
function AttendanceReportContent() {
  ...
  const [selectedInstructor,  setSelectedInstructor]  = useState(filterInstructorId ?? "");
  ...
  // Seçili grup artık dropdown'da yoksa sıfırla
  useEffect(() => {
  ...
  const backUrl = filterInstructorId ? "/dashboard/attendance-report" : null;
