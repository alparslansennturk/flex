...
import { unregisterPushToken } from "@/app/lib/domain/services/connect-push-service";

/** POST /api/flexos/connect/push/unregister — çıkış yaparken bu cihazın token'ını sil. */
export const POST = withAuth(async (req: NextRequest, caller) => {
  ...
  await unregisterPushToken(principal, body.token, firestoreConnectPushRepo);
