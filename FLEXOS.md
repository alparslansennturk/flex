...
**Durum:** Yoklama Aşama-1 (UI) BİTTİ. Aşama-2'den SADECE Tatil günleri bitti — course-progress/donut, öğrenci detay modalı, auto-close cron, ders istisnası backend'i HENÜZ YOK. Tarayıcıda hiç test edilmedi (bu oturumda login yok). Detaylı not: Claude memory `project_attendance_v2_rules.md`.
