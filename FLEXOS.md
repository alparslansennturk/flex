...
- [ ] **SIRADAKİ — Dikey Dilim:** öğrenci satış UI → grup ekle UI (eğitmen havuzu = `users` instructor'lardan) → demo satış → grup-eğitmen-eğitmende görünür. Kurumsal **Firmalar** modülü ileride ([[kurumsal-modul-firmalar]]). Katalogda bireysel/kurumsal **ayrı gruplu liste** (asla iç içe).
